    ...
    <FlexBox bgImage={bgImage} width={width} height={height} borderRadius="0px" margin="0px" alignItems="flex-end" linearGradient={linearGradient}>
        ...
        <FlexBox margin="12px">
          {/* <Search size="large"
                        ...
                        <Input bgImage="/icons8-search-48.png" bgSize="30px" type="email" placeholder='ex/jdoe@my.bcit.ca' margin="0px 20px 0px 20px" padding='0 0 0 45px' width="90vw" maxWidth="900px" justifyContent="flex-start"></Input>
                        </FlexBox>
        </FlexBox>
    </FlexBox>
  )
