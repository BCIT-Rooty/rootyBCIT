...
position="fixed",
    ...
    return(
    <FlexBox width="100%" justifyContent="space-around" z-index="1" position="absolute" padding="10px" topBorder="1px #EDEDED solid" bottom="0" position={position} zIndex="20" bgColor="white">
