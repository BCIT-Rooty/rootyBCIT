...
margin
    ...
    return(
    <FlexBox width="100%" justifyContent="space-around" padding="10px" margin={margin} topBorder="1px #EDEDED solid" top="93vh" position={position} zIndex="20" bgColor="white">
