...
export default function MyMessage({
    ...
    if (type==="messageImage") {
        ...
        return(
            <FlexBox width="100%" justifyContent="flex-end" padding="0 15px 0 15px" alignContent="flex-start">
            <FlexBox dir="column" alignItems="flex-end">
        <FlexBox dir="column" maxWidth="80%" minHeight="45px" minWidth="100px" padding="10px 10px 10px 10px" bgColor="#4F4DB0" borderRadius="16px 16px 0px 16px" margin="3px">
