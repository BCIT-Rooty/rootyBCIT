...
export default function ChatHeader({
    ...
    return(
        <FlexBox position={position} width="100%" height="60px" justifyContent="flex-start" padding="0 3px 10px 3px" margin={margin} bottomBorder="0.5px #545454 solid" bgColor="white">
