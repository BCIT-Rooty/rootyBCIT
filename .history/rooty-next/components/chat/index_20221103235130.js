    ...
    return(
        <FlexBox width="88%" height="60px" justifyContent="flex-start" padding="0 3px 0 3px" margin="9px">
                ...
                <FlexBox width="265px" dir="column" alignItems="flex-start" margin="0 10px 0 13px">
                    <FlexBox justifyContent="space-between"><Text txt={postTitle} size="18px" padding="2px"></Text> <FlexBox margin="3px"><Text size="14px" txt={date}></Text></FlexBox></FlexBox>
                    <FlexBox justifyContent="space-between"><Text txt={userName} size="15px" padding="2px"></Text> <FlexBox margin="3px" width="15px" height="15px" bgColor="#4F4DB0" borderRadius="50%"></FlexBox></FlexBox>
                </FlexBox>
                <FlexBox dir="column">
