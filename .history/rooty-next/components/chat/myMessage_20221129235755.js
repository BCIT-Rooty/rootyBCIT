...
export default function MyMessage({
    ...
    if (type==="messageImage") {
        ...
        <FlexBox dir="column" maxWidth="80%" minHeight="45px" minWidth="100px" padding="10px 10px 10px 10px" alignItems="flex-start" bgColor="#4F4DB0" borderRadius="16px 16px 0px 16px" margin="3px">
