...
export default function LeaveReview(){
    ...
    return(
    <FlexBox width="94vw" height="550px" padding="20px" border="grey 1px solid" filter="box-shadow: 0px 0px 4px 0px #00000040" borderRadius="16px">
        <FlexBox width="100%" height="100%" dir="column" alignItems="flex-start" justifyContent="center">
            ...
            <Button width="84vw" margin="5px 0px" type="button" txt="Post Review" bgColor="#4F4DB0" borderRadius="16px"></Button>
            <Button width="84vw" margin="5px 0px" type="button" txt="Cancel" color="black" bgColor="#FFFFFF" borderRadius="16px" border="1px solid black"></Button>
            </FlexBox>
