...
export default function LeaveReview(){
    ...
    return(
    <FlexBox width="94vw" height="600px" padding="20px" border="black 1px solid" filter="box-shadow: 0px 0px 4px 0px #00000040" borderRadius="16px">
        <FlexBox width="100%" height="100%" dir="column" alignItems="flex-start" justifyContent="flex-start">
            ...
            <FlexBox dir="column" alignItems="flex-start" margin="10px 0">
                <Text txt="Write a review" weight="700" size="24px" padding="3px 0"></Text>
            ...
            <Button width="82vw" padding="0px 20px" type="button" txt="Publish" bgColor="#4F4DB0" borderRadius="16px"></Button>
            <Button width="82vw" padding="0px 20px" type="button" txt="Cancel" color="black" bgColor="#FFFFFF" borderRadius="16px" border="1px solid black"></Button>
            </FlexBox>
