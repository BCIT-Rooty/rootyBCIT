    ...
    return ( 
        ...
        <Wrapper alignItems="flex-start" height="fit-content" dir="column" padding="0 0 50px 0">
            ...
            {/* <ImgPlaceholder bgImage={postPhoto} width="100%" height="328px"></ImgPlaceholder> */}
                ...
                <FlexBox margin="0 0 30px 0px">
                <Button width="fit-content" padding="0px 20px" type="add" iconName="phone" txt="Write a review" bgColor="#4F4DB0" borderRadius="16px" border="2px solid #232323"></Button>
                </FlexBox>
            {/* </FlexBox> */}
