    ...
    return ( 
        ...
        <Wrapper alignItems="flex-start" height="fit-content" dir="column" padding="0 0 50px 0">
            ...
            {/* <ImgPlaceholder bgImage={postPhoto} width="100%" height="328px"></ImgPlaceholder> */}
                ...
                <Button onClick={()=> onCLickReview()} width="fit-content" padding="0px 20px" type="add" iconName="write" txt="Write a review" bgColor="#4F4DB0" borderRadius="16px" border="2px solid #232323"></Button>
                </FlexBox>

                <FlexBox width="100vw" height="fit-content" >
                    <AnimatePresence exitBeforeEnter>
                    {showModal == 2 && <FlexBox width="100%" height="100vh" maxWidth="900px" dir="column" alignItems="flex-start" justifyContent="flex-start" position="fixed" overflowY="scroll" top="0px">
