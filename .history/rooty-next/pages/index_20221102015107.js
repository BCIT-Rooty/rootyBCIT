...
export default function Home() {
  ...
  return (
    <FlexBox dir="column" bgColor="#FFFDFA">
      ...
      <FlexBox width="100vw" height="70vh" bgColor="#4F4DB0" borderRadius="15px 15px 0 0" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 150px 0px">
        {steps === 1 && <div>
        ...
        {steps === 2 && <div>
          <Text padding='60px 0px 0px 20px' size='42px' weight='700' txt='Welcome' color="white"></Text>
          <Text padding='30px 0px 10px 20px' size='18px' weight='500' txt="BCIT Email" color="white"></Text>
          <Input type="text" placeholder='ex/jdoe@my.bcit.ca' margin="0px 0px 0px 20px"></Input>
          <Text padding='30px 0px 10px 20px' size='18px' weight='500' txt="Password" color="white"></Text>
          <Input type="text" placeholder='' margin="0px 0px 0px 20px"></Input>
          </div>
        }
      <FlexBox width='100vw' padding="0px 20px 0px 20px" justifyContent="flex-start">
            <Button type='next' txt='Next' color="black" margin='5px 5px 8px 0px' width="93vw" onNext={steps + 1}></Button>
      </FlexBox>
