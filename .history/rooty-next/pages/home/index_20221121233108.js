...
export default function Home(){
  ...
  <Wrapper dir="column" height="fit-content" padding="0 0 80px 0">
    <NotificationsIcon fontSize="large" sx={{ color: "#FEB506" }}></NotificationsIcon>
      <Text txt="Welcome, Student" padding="50px 0px 0px 20px" size="24px" weight="bolder" width="100%" maxWidth="900px" justifyContent="flex-start" ></Text>
