    ...
    <ChatHeader margin="0px 9px 20px 0px" position="fixed"/>
      ...
      >
            <FlexBox
              ...
              height="fit-content"
            >
              <FlexBox justifyContent="flex-end" width="100%" minHeight="50vh" maxHeight="77vh" position="absolute" bottom="70px" overflowY="scroll">
                <FlexBox id="thing" dir="column" position="relative" bottom="0">
                  {chats.map((m) => m)}
                </FlexBox>
              </FlexBox>
              <ChatNavBar
