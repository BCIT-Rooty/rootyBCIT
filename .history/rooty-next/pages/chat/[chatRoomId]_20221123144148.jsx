...
export default function ACertainChatRoom(props) {
  ...
  useEffect(() => {
    document.querySelector("#dumpling").scrollTo({top: Number.MAX_SAFE_INTEGER, behavior: "smooth"})
  }, [messages])
    ...
    <ChatHeader margin="0px 9px 20px 0px" position="fixed"/>
      ...
      >
            <FlexBox
              ...
              height="fit-content"
            >
              <FlexBox id="dumpling" justifyContent="flex-end" width="100%" minHeight="50vh" maxHeight="77vh" position="absolute" bottom="70px" overflowY="scroll">
                <FlexBox dir="column" position="relative" bottom="0">
                  {chats.map((m) => m)}
                </FlexBox>
              </FlexBox>
              <ChatNavBar
