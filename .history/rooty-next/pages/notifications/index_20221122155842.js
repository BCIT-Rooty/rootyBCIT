...
<Wrapper alignItems="flex-start">
    ...
    <Notification message="Welcome to Rooty!"></Notification>
     ...
     <AnimatePresence exitBeforeEnter>
      {showModal === 2 && <FlexBox position="absolute" top="-10px" left="0vw" width="100vw"><motion.div initial={{y: 900}} animate={{y: 0, transition:{duration: 0.7, delay:0}}} exit={{y:900}}><Article article={Article1()} onClick={()=>setShowModal("default")} txt="How to Write the Perfect Freelancing Bio" bgImage="/tip1.png"/></motion.div></FlexBox>}
      </AnimatePresence>
</Wrapper>
)}