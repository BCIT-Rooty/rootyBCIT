...
<Wrapper alignItems="flex-start" overflowX="hidden" overflowY="hidden" dir="column">
    ...
    <FlexBox width="100vw" height="100vh">
            <AnimatePresence exitBeforeEnter>
            {showModal == 2 && <FlexBox width="100%" maxWidth="900px" dir="column" alignItems="flex-start" justifyContent="flex-start" position="fixed" top="0px">
            ...
            {showModal == 1 && <FlexBox width="100%" maxWidth="900px" dir="column" alignItems="flex-start" justifyContent="flex-start" position="fixed" top="0px">
                <motion.div initial={{x: 450}} animate={{x: 0, transition:{duration: 0.4, delay:0}}} exit={{x:450}}>
                
                <Article article={Welcome()} onClick={()=>setShowModal("default")} txt="Welcome to Rooty!" bgImage="/tip1.png"/>
