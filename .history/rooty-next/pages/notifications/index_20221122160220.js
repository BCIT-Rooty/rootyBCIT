...
<Wrapper alignItems="flex-start">
    ...
    <Notification message="Welcome to Rooty!"></Notification>
     ...
     <AnimatePresence exitBeforeEnter>
      {showModal === 2 && <FlexBox position="absolute" ><motion.div initial={{x: 900}} animate={{x: 0, transition:{duration: 0.7, delay:0}}} exit={{x:900}}><Article article={Article1()} onClick={()=>setShowModal("default")} txt="How to Write the Perfect Freelancing Bio" bgImage="/tip1.png"/></motion.div></FlexBox>}
      </AnimatePresence>
</Wrapper>
)}