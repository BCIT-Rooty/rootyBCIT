  ...
  return (
    <FlexBox dir="column" bgColor="#FFFDFA">
      ...
      <FlexBox width="100vw" height="70vh" bgColor="#4F4DB0" borderRadius="15px 15px 0 0" justifyContent="flex-start" alignItems="flex-start" dir="column">
        ...
        <Text padding='30px 0px 10px 20px' size='18px' weight='500' txt="BCIT Email"></Text>
        <Input type="email" placeholder='ex/jdoe@my.bcit.ca'></Input>
        <Text padding='30px 0px 10px 20px' size='18px' weight='500' txt="Password"></Text>
