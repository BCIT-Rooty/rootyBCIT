...
export default function OneCategory({ parsedItems, parsedCategoryName }) {
    ...
    return (
            <Wrapper alignItems="start" height="fit-content">
                ...
                <FlexBox position="relative" top="40px" left="-155px" z-index="2"><ArrowBackIosIcon fontSize="large" onClick={() =>handleLinkClick()}></ArrowBackIosIcon></FlexBox>
                    <FlexBox width="100%" dir="column" z-index="-2">
