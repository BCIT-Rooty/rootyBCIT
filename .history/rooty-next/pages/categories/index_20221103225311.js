...
export default function Categories({jsonCategories}) {
  ...
  return (
    <>
      ...
      <Wrapper>
      <FlexBox dir="column" width="100%">
            <FlexBox width="100%" border="1px black solid" height="56px" justifyContent="flex-start" padding="5px">

                    <ImgPlaceholder margin="5px" height="50px" width="50px" bgImage="/face3.jpg" borderRadius="50%"></ImgPlaceholder>
                <FlexBox width="261px" dir="column" alignItems="flex-start" margin="10px">
