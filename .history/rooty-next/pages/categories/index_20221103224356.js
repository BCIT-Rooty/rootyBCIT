...
export default function Categories({jsonCategories}) {
  ...
  return (
    <>
      ...
      <Wrapper>
      <FlexBox dir="column" width="100%">
            <FlexBox width="100%" border="1px black solid" height="56px" justifyContent="flex-start">

                    <ImgPlaceholder height="50px" width="50px" bgImage="/face3.jpg" borderRadius="50%"></ImgPlaceholder>
                <FlexBox width="261px" dir="column" justifyContent="flex-start" >
