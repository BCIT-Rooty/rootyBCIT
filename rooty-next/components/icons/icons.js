...
function HandleHeartClick(e){
  ...
  heartsItem = e.target.closest('div').parentNode.parentNode.parentNode.parentNode.id;
...
// ------HEART
export const Heart = () => (
  <Rating icon='heart' defaultRating={0} maxRating={1} size='huge' link="true" onClick={HandleHeartClick}/>
)
