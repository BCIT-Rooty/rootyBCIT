...
export default function NotMyMessage({
    ...
    return(
        ...
        <FlexBox dir="column" minWidth="100px" maxWidth="80%" minHeight="45px" padding="10px 10px 10px 10px" bgColor="#808080" borderRadius="16px 16px 16px 0px" margin="5px" alignItems="flex-start">
            {type==="messageImage" && <ImgPlaceholder bgImage={image} width="100%" height="150px" borderRadius="5px"></ImgPlaceholder>}
            <Text txt={text} color="#FFFFFF"></Text>
        </FlexBox>
        </FlexBox>
    )
}