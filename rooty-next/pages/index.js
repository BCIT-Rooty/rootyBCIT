      ...
      <FlexBox width="100%" height="70vh" bgColor="#4F4DB0" borderRadius="15px 15px 0 0" justifyContent="flex-start" dir="column" padding="0px 0px 50px 0px" boxShadow="0px -4px 9px rgba(0, 0, 0, 0.25);">
        ...
        <form onSubmit={registerUser}>
          <AnimatePresence exitBeforeEnter>
            {steps === 1 && <FlexBox width="100%" maxWidth="900px" dir="column" alignItems="flex-start" justifyContent="flex-start" >
              <motion.div key={steps} initial={{ x: 400 }} animate={{ x: 0, transition: { duration: 0.4, delay: 0.7 } }} exit={{ x: -400 }}>
                ...
                <Input bgImage="/bx-envelope.svg" type="email" onChangingTheText={(e) => setEmail(e.target.value)} placeholder='jdoe@my.bcit.ca' margin="0px 20px 0px 20px" padding='0 0 0 45px' width="90vw" maxWidth="900px" justifyContent="flex-start"></Input>
                <Text padding='30px 0px 10px 20px' size='18px' weight='500' txt="Password" color="white" ></Text>
                <Input bgImage="/bx-lock.svg" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder='' margin="0px 20px 0px 20px" padding='0 0 0 45px' width="90vw" maxWidth="900px" justifyContent="flex-start" ></Input>
            ...
            {steps === 2 && <FlexBox width="100%" maxWidth="900px" dir="column" alignItems="flex-start" justifyContent="flex-start" >
              <motion.div key={steps} initial={{ x: 400 }} animate={{ x: 0, transition: { duration: 0.4, delay: 0.7 } }} exit={{ x: -400 }}>
                ...
                <Input type="text" placeholder='Last Name' value={lastName} onChange={(e) => setLastName(e.target.value)} margin="30px 20px 10px 20px" width="90vw" maxWidth="900px" justifyContent="flex-start"></Input>
              </motion.div>
            </FlexBox>
          ...
          <FlexBox width='100vw' padding="0px 20px 0px 20px" position="absolute" bottom="30px">
            <Button type='submit' txt={steps <= 4 && "Next" || "Finish"} color="black" width="90vw" maxWidth="300px" onNext={() => HandleSteps(Math.min(5, steps + 1))} size="21px" fontWeight="700" padding="25px"></Button>
          </FlexBox>
        </form>
      </FlexBox>
    </Wrapper>
