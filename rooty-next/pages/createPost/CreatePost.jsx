  ...
  return (
    <>
      <Wrapper justifyContent="flex-start" alignItems="flex-start" dir="column">
                  ...
                  <FlexBox topBorder="0.5px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 15px 0px">
                  ...
                  <FlexBox topBorder="0.5px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 20px 0px">
                      <Text txt="Type Keywords" size="16px" weight="bold" padding="15px 0px 20px 20px"></Text>
                      <Input placeholder="Type Keywords for your Post" type="search" border="solid 1px #545454" margin="0px 0px 0px 20px"></Input>
                  </FlexBox>
                  <FlexBox topBorder="0.5px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 20px 0px">
                      <Text txt="Post Title" size="16px" weight="bold" padding="15px 0px 20px 20px"></Text>
                      <Input placeholder="Type your Post's Title" type="search" border="solid 1px #545454" margin="0px 0px 0px 20px"></Input>
                  </FlexBox>
                  <FlexBox topBorder="0.5px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 20px 0px">
                      <Text txt="Describe your Service" size="16px" weight="bold" padding="15px 0px 20px 20px"></Text>
                      <TextInput placeholder="Sell yourself! Describe what awesome talents you have!" type="textarea" border="solid 1px #545454" margin="0px 0px 0px 20px"></TextInput>
                  </FlexBox>
                  <FlexBox topBorder="0.5px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" dir="column" padding="0px 0px 20px 0px">
                      <Text txt="Barter Service Needs - Optional" size="16px" weight="bold" padding="15px 0px 20px 20px"></Text>
                      <TextInput type="textarea" border="solid 1px #545454" margin="0px 0px 0px 20px" placeholder="Describe your barter service needs, if applicable"></TextInput>
                  </FlexBox>
                  <FlexBox topBorder="0px solid #545454" width="100vw" justifyContent="flex-start" alignItems="flex-start" padding="0px 0px 20px 0px">
                      <Text txt="Price" size="16px" weight="bold" padding="15px 0px 20px 20px"></Text>
                      <Input type="text" border="solid 1px #545454" margin="10px 0px 0px 20px" placeholder=" " width="60px"></Input>
                  </FlexBox>
                  <FlexBox padding="0px 0px 85px 0px" width="100vw">
                      <Button onClick={()=>setShowDownload("active")} txt="Publish" size="20px" padding="22px" width="120px" color="white" border="solid 1px #545454" margin="10px 0px 0px 20px"></Button>
                  </FlexBox>
                  <AnimatePresence exitBeforeEnter>
                      {showDownload === "active" && <FlexBox position="absolute" left="0" zIndex="30"><motion.div initial={{opacity: 0}} animate={{opacity: 1, transition:{duration: 0.2, delay:0}}} exit={{opacity:0}}><DownloadPopUp height="180vh" onClose={()=>setShowDownload("default")} txt="Successfully Posted 😁"></DownloadPopUp></motion.div></FlexBox>}
                  </AnimatePresence>
