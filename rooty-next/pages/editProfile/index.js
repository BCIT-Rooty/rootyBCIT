...
export default function EditProfile() {
    ...
    return ( <Wrapper dir="column" width="100vw" alignItems="start" height="fit-content" padding="0 0 80px 0">
      ...
      <TitlePage txt="Profile" type="Edit"/>
      ...
      <HorizontalScrollContainer justifyContent="flex-start" alignItems="flex-start" maxWidth="900px" width="94vw" margin="0px 0px 0px 20px">
        <FlexBox>
          {descript[1].map((o) => (
