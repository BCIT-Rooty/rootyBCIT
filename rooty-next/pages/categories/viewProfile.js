    ...
    >
      ...
      {report === true && (
        ...
        >
          ...
          <Text
            txt="Select a reason for reporting this user."
            weight="500"
            size="12px"
            padding="10px 0"
          ></Text>
      ...
      {showDownload === "active" && (
        <FlexBox position="absolute" left="0" top="0" zIndex="30">
          <motion.div
            initial={{ opacity: 0 }}
